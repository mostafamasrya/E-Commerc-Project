...
submitbtn1.addEventListener("click",function(e){
    if(subname == "false" || subuser == "false" || subemail == "false" || subphone == "false" || subpass1 == "false" || subpass2 == "false" || (radio1.checked != true && radio2.checked != true && radio3.checked != true)){
        e.preventDefault()
    ...
    // if(radio1.value != "checked" || radio2.value != "checked" || radio3.value != "checked"){
